    ...
    <React.Fragment>
      <CardBody className={"border border-dashed border-end-0 border-start-0 " + filterClass}>
        <form>
          <Row className="g-3">
            <Col sm={5}>
              <div className={(isProductsFilter || isContactsFilter || isCompaniesFilter || isNFTRankingFilter || isLeadsFilter) ? "search-box me-2 mb-2 d-inline-block" : "search-box me-2 mb-2 d-inline-block col-12"}>
                <input
                  onChange={(e) => {
